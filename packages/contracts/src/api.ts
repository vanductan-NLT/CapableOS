...
import type { Task, TaskStatus, Feedback } from "./task.js";
import type { Agent, NewAgentInput, AgentPatch } from "./agent.js";
...
// Re-export domain types kept alongside API shapes for convenience.
export type { Decision, Task, TaskStatus, Feedback, Agent, NewAgentInput, AgentPatch };
